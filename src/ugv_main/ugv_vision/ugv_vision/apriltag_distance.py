...
class ApriltagDistance(Node):
    def __init__(self, visualize: bool = False):
        ...
        self.camera_info_sub = self.create_subscription(
            CameraInfo, "/image_rect/camera_info", self.camera_info_callback, 10
        )
    ...
    def tag_callback(self, msg: AprilTagArray):
        ...
        for det in msg.detections:
            ...
            _, rvec, tvec = cv2.solvePnP(self.tag_points_3d,corners, self.K, None, flags=cv2.SOLVEPNP_IPPE_SQUARE)
